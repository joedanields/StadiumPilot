# StadiumPilot — Agent & Prompt Design

This file documents the AI agent architecture, prompt design, and reasoning contract for StadiumPilot. Keep this updated as you build — it doubles as the backbone of your LinkedIn writeup ("prompt design" is explicitly scored).
